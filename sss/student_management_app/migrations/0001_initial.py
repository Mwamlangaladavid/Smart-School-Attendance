# Generated by Django 4.2.18 on 2025-02-17 22:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.academicyear')),
            ],
        ),
        migrations.CreateModel(
            name='Grades',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('grade_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.grades')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disability', models.CharField(choices=[('None', 'None'), ('Physical', 'Physical'), ('Visual', 'Visual'), ('Hearing', 'Hearing'), ('Other', 'Other')], default='None', max_length=25)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('academic_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.academicyear')),
                ('grade_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.grades')),
                ('stream_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.streams')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='stream_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='student_management_app.streams'),
        ),
        migrations.CreateModel(
            name='AdminHOD',
            fields=[
